...
function filtrarIndex() {
    ...
    if (indexPalabras.indexOf(busqueda) !== -1) {
        html = html + '<div class=article>Coincidencias en <a class="nav-link" href="index.html" title="index">Index</a> </div>'
    }
}
...
function filtrarAficiones() {
    ...
    if (indexPalabras.indexOf(busqueda) !== -1) {
        html = html + '<div class=article>Coincidencias en <a class="nav-link" href="aficiones.html" title="aficiones">Aficiones</a> </div>'
    }
}
...
function filtrarMusica() {
    ...
    if (indexPalabras.indexOf(busqueda) !== -1) {
        html = html + '<div class=article>Coincidencias en <a class="nav-link" href="index.html" title="musica">Música</a> </div>'
    }
}
...
function filtrarSeries() {
    ...
    if (indexPalabras.indexOf(busqueda) !== -1) {
        html = html + '<div class=article>Coincidencias en <a class="nav-link" href="series.html" title="series">Series</a> </div>'
    }
}